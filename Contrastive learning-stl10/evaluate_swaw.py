...
def main():
    ...
    # Ako imaš druge encodere, možeš ih ovdje ostaviti:
    # try:
    ...
    # === OVDJE DODAJEMO SWAV ENCODER ===
    try:
        encoders["SwAV"] = load_encoder_from_ckpt("stl10_swav_encoder.pth")
    except FileNotFoundError:
        print("WARNING: stl10_swav_encoder.pth not found, skipping SwAV")
